...
namespace NPOI.POIFS.Crypt.BinaryRC4
{
    ...
    public class BinaryRC4Decryptor : Decryptor
    {
        ...
        private sealed class BinaryRC4CipherInputStream : ChunkedCipherInputStream
        {
            ...
            public BinaryRC4CipherInputStream(BinaryRC4Decryptor outer, InputStream stream, long size, BinaryRC4Decryptor decryptor)
                : base(stream, size, outer._chunkSize, decryptor)
            {
            }

            public BinaryRC4CipherInputStream(BinaryRC4Decryptor outer, InputStream stream, int size, int initialPos, BinaryRC4Decryptor decryptor)
                : base(stream, size, outer._chunkSize, initialPos, decryptor)
            {
            }
        }
        ...
        public override InputStream GetDataStream(DirectoryNode dir)
        {
            ...
            return new BinaryRC4CipherInputStream(this, dis, _length, this);
