...
namespace NPOI.HSSF.Record
{
    ...
    public class FilePassRecord : StandardRecord
    {
        ...
        /// <summary>
        /// Creates a FilePassRecord for XOR encryption with the specified password
        /// </summary>
        /// <param name="password">The password to use for encryption</param>
        /// <returns>A new FilePassRecord configured for XOR encryption</returns>
        public static FilePassRecord CreateFilePassRecord(string password)
        {
            ...
            FilePassRecord filePassRecord = new FilePassRecord(EncryptionMode.XOR);
            
            // Initialize the XOR encryption with the password
            XOREncryptionVerifier verifier = (XOREncryptionVerifier)filePassRecord.GetEncryptionInfo().Verifier;
            ...
            verifier.SetEncryptedKey(shortBuf);
            LittleEndian.PutUShort(shortBuf, 0, verifierComp);
            verifier.SetEncryptedVerifier(shortBuf);
